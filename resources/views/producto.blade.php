...
@section('content')
    <main class="my-2">
        ...
        <div class="card card-default">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('cart.agregar') }}" role="form" enctype="multipart/form-data">
                    @csrf
                ...
                <div class="flex flex-col w-full p-8 text-gray-800 bg-white shadow-lg pin-r pin-y md:w-4/5 lg:w-4/5">
                    ...
                    <div class="table-responsive">
                            ...
                            <tbody>
                                @foreach ($cartItems as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <div>
                                                <div>
                                                    ...
                                                    <form action="{{ route('cart.update3') }}" method="POST">
                                                        @csrf
                                        ...
                                        <td>
                                            <form action="{{ route('cart.removeProducto') }}" method="POST">
                                                @csrf
                        ...
                        <div >
                            ...
                            <div class="pull-left">
                                <a class=" btn btn-success " href="{{ route('cart.saleProducto') }}" > Ingresar Producto</a>

                            </div>

                            <form action="{{ route('cart.clearProducto') }}" method="POST">
                                @csrf
