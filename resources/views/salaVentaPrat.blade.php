    ...
    <main class="my-2">
        ...
        <div class="card card-default">
            <div class="card-header">
                ...
                <h3 class="alert alert-warning">Recuerda ingresar solo un tipo de lana</h3>
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('cart.storePrat') }}" role="form" enctype="multipart/form-data">
                    @csrf
                            ...
                            <tbody>
                                @foreach ($cartItems as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <div>
                                                <div>
                                                    ...
                                                    <form action="{{ route('cart.update5') }}" method="POST">
                                                        @csrf
                                        ...
                                        <td>
                                            <form action="{{ route('cart.removeSalaVentasPrat') }}" method="POST">
                                                @csrf
                ...
                <!--
                    ...
                    -->
                        ...
                        <div >
                            ...
                            <div class="pull-left">
                                <a class=" btn btn-success " href="{{ route('cart.saleVentasPrat') }}" > Crear Venta </a>

                            </div>

                            <form action="{{ route('cart.clearsSalaVentaPrat') }}" method="POST">
                                @csrf
