...
<div class="content-wrapper">
    ...
    <div class="page-header">
        <h3 class="page-title">
            Panel administrador Palmeras
        </h3>

        <a class="btn btn-primary" href="{{route('home')}}">Volver a panel administrador Prat</a>
    </div>
        ...
        <div class="col-md-6 grid-margin stretch-card">
            <div class="card text-white bg-warning">
                ...
                <div class="card-body pb-0">
                    ...
                    <div class="text-value h4"><strong>CHL {{$total->totalcompra}} (MES ACTUAL)</strong>
                    </div>
                    <div class="h3">Compras</div>
                </div>
                <div class="chart-wrapper mt-3 mx-3" style="height:35px;">
                    <a href="{{route('purchase.index')}}" class="small-box-footer h4">Compras <i
        ...
        <div class="col-md-6 grid-margin stretch-card">
            <div class="card  text-white bg-info">
                ...
                <div class="card-body pb-0">
                    ...
                    <div class="text-value h4"><strong>CHL {{$total->totalventa}} (MES ACTUAL) </strong>
                    </div>
                    <div class="h3">Ventas</div>
                </div>
                <div class="chart-wrapper mt-3 mx-3" style="height:35px;">
                    <a href="{{route('sale.index')}}" class="small-box-footer h4">Ventas <i
                            class="fa fa-arrow-circle-right"></i></a>
                </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-primary"
                                            href="{{route('home.showBodegas', $productosvendido->id)}}">
