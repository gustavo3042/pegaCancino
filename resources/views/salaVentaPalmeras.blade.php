...
@section('content')
    <main class="my-2">
        ...
        <div class="card card-default">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('cart.storePalmeras') }}" role="form" enctype="multipart/form-data">
                    @csrf
                            ...
                            <tbody>
                                @foreach ($cartItems as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <div>
                                                <div>
                                                    ...
                                                    <form action="{{ route('cart.update7') }}" method="POST">
                                                        @csrf
                                        ...
                                        <td>
                                            <form action="{{ route('cart.removeSalaVentasPalmeras') }}" method="POST">
                                                @csrf
                ...
                <!--
                    ...
                    -->
                        ...
                        <div >
                            ...
                            <div class="pull-left">
                                <a class=" btn btn-success " href="{{ route('cart.saleVentasPalmeras') }}" > Crear Venta </a>

                            </div>

                            <form action="{{ route('cart.clearsSalaVentasPalmeras') }}" method="POST">
                                @csrf
