                    ...
                    <tr>
                        <th style='font-size: 20px;'>
                            <p id="proveedor">Nombre: {{$sale->user->name}}<br>
                                ...
                                <p style='font-size: 20px;'>Venta Realizada</p>
                        </th>
                    </tr>
                </tbody>
            </table>
            ...
            <table id="faccomprador">
                ...
                <tbody>
                    <tr>
                          ...
                          <td style='font-size: 20px;'>{{$sale->created_at}}</td>
                    </tr>
                </tbody>
            </table>
        </div>
            ...
            <table id="facproducto">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style='font-size: 20px;' >{{$saleDetail->product->name}}</td>
                        <td style='font-size: 20px;' >{{$saleDetail->product->barcode}}</td>
            ...
            <tbody id="tab" >
                ...
                <tr >
                    <th style='font-size: 20px;' colspan="4">
                        ...
                        <p >Total sin descuento: ${{number_format($subTotal)}}<p>
                        <p >Total a pagar: ${{number_format( $subTotal - $desc )}}<p>
                        <p>Descuento 10%: ${{number_format($desc)}}</p>    
                    </th>
