...
<p>Ingreso de productos a bodega Palmeras</p>
<style>
    body {
        /*position: relative;*/
        /*width: 16cm;  */
            ...
            <table id="facproducto">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$purchaseDetail->bodega->name}}</td>
                        <td>{{$purchaseDetail->bodega->barcode}}</td>
                       
                        <td>$/ {{number_format($purchaseDetail->price * 0.19,1) }}</td>
                ...
                -->
                    ...
                    <tr>
                        ...
                        <td>
                            <p align="right">$/ {{number_format($purchase->iva,1)}}</p>
                        </td>
                    </tr>
                    <tr>
                        <th colspan="3">
                        ...
                        <td>
                            <p align="right">$/ {{number_format($purchase->total,1)}}<p>
                        </td>
                    </tr>
