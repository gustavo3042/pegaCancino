                ...
                <div class="card-body">
                    ...
                    <div class="row ">
                        ...
                        <div class="col-12 col-md-4 text-center">
                            <span>10%: <b> </b></span>
                            <div class="form-group">
                                <strong>{{number_format(($totalSinDesc - $totalSinDesc * 0.1) * 0.1 )}}</strong>
                            </div>
                        </div>
                    </div>
...
{{--
                                        ...
                                        <a href="{{route('sale.showPalmeras', $sale->id)}}" class="jsgrid-button jsgrid-edit-button"><i class="far fa-eye"></i></a>
